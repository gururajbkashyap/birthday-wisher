const C = "rgba(212,175,55,0.55)";
const C2 = "rgba(212,175,55,0.25)";
const LINE = 1.5;
const SIZE = 56;
...
export default function PageBorder() {
  return (
    <>
      ...
      {/* thin edge lines */}
      <div style={{
        position: "fixed", top: 12, left: 68, right: 68,
        height: 1, background: `linear-gradient(90deg, transparent, ${C}, transparent)`,
        pointerEvents: "none", zIndex: 10,
      }} />
      <div style={{
        position: "fixed", bottom: 12, left: 68, right: 68,
        height: 1, background: `linear-gradient(90deg, transparent, ${C}, transparent)`,
        pointerEvents: "none", zIndex: 10,
      }} />
      <div style={{
        position: "fixed", left: 12, top: 68, bottom: 68,
        width: 1, background: `linear-gradient(180deg, transparent, ${C}, transparent)`,
        pointerEvents: "none", zIndex: 10,
      }} />
      <div style={{
        position: "fixed", right: 12, top: 68, bottom: 68,
        width: 1, background: `linear-gradient(180deg, transparent, ${C}, transparent)`,
        pointerEvents: "none", zIndex: 10,
      }} />
    </>
